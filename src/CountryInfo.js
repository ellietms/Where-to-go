            ...
            <div className="information-country">
                ...
                <div className="mt-sm-5 d-flex justify-content-between">
                    ...
                    <p class="d-flex d-lg-inline-flex mr-lg-0 col-lg-4
                     ...
                     <strong class="borders">Border Countries:</strong> </p>
                    <span class="col-lg-6 mt-sm-1 mt-md-0 d-sm-flex 
                    flex-md-column flex-lg-row d-lg-inline-flex">{nameOfCountry}</span>
                    </div>
                 </div>
             </div>
        </div>
